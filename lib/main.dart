...
//import 'package:diya/screens/testingComponent.dart';
import 'package:diya/pages/restController.dart';
...
class SplashScreenState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Container(
        color: Colors.white,
        child:new Image.asset('assets/images/dIyA.PNG'),
    );
  }
}
